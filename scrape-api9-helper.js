// scrape-api9-helper.js
// Helper script for API 9 to assist with API 8's workload
...
const MAX_RETRIES = 3;
const API_INDEX = 8; // Using API 9 (index 8) with new key: [your_api_key_here]
// We're splitting API 8's range (203497-232567) - API 9 takes second half
const START_INDEX = 218032; // Midpoint of API 8's range
const END_INDEX = 232567;   // End of API 8's range
...
async function parallelBatchScrape() {
  ...
  console.log('🔍 API 9 HELPER BATCH DETAIL SCRAPER');
  console.log('━'.repeat(70));
  console.log(`API Key Index: ${apiKeyIndex + 1}/${API_KEYS.length} (API 9 helping API 8)`);
  ...
  try {
    ...
    const query = {
      $and: [
        ...
        { detailsScrapedByApi: { $ne: 7 } }           // Not processed by API 8 yet
      ]
    };
    ...
    console.log('');
    console.log('━'.repeat(70));
    console.log(`✅ API 9 HELPER COMPLETE!`);
    console.log('━'.repeat(70));
    console.log('');
