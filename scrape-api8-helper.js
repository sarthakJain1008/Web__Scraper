// scrape-api8-helper.js
// Helper script for API 8 with the same new key
...
const MAX_RETRIES = 3;
const API_INDEX = 7; // Using API 8 (index 7) with the new key: [your_api_key_here]
const START_INDEX = 203497; // Start of API 8's range
...
async function parallelBatchScrape() {
  ...
  console.log('🔍 API 8 HELPER BATCH DETAIL SCRAPER');
  console.log('━'.repeat(70));
  console.log(`API Key Index: ${apiKeyIndex + 1}/${API_KEYS.length} (API 8 with new key)`);
  ...
  try {
    ...
    console.log('');
    console.log('━'.repeat(70));
    console.log(`✅ API 8 HELPER COMPLETE!`);
    console.log('━'.repeat(70));
    console.log('');
